...
### Fixture Projects
- `test_repos/fixture-python-calculator/` - Python with intentional failure
- `test_repos/fixture-python-api/` - Python with passing tests
- `test_repos/fixture-javascript-app/` - [TO BE ADDED] Jest tests
- `test_repos/fixture-go-service/` - [TO BE ADDED] Go tests
...
7. Merge automatically with `gh pr merge`
